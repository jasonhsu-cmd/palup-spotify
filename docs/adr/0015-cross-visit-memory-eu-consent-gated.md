...
- **Amendment SECURITY-CLEARED, pending owner re-acceptance + legal (2026-08-06):**
  ...
  **Nothing is closed: ADR-0019 is security-cleared (third review) but UNBUILT and gated on owner
  re-acceptance + legal**, so the rows in
